...
/**
 * Prepend filename metadata to extracted text for richer embeddings.
 * Uses only basename — no folder/category leakage.
 * @param {string} pdfPath - Absolute path to the PDF
 * @param {string} text - Extracted text content
 * @returns {string} Text prefixed with filename
 */
export function enrichText(pdfPath, text) {
