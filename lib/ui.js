...
import { getAllCentroids, loadBayesState, getMeta, getAllDocs, getDocsByFolder } from './db.js';
...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .name-option:hover, .name-option.highlighted {
    background: #f0f4ff;
  }
  ...
  .name-badge.similarity { background: #d4edda; color: #155724; }
  .name-badge.llm { background: #cce5ff; color: #004085; }
  .name-badge.fallback { background: #e2e3e5; color: #383d41; }
  .name-loading {
    font-size: 11px;
    color: #888;
  }
